...
all: main.o general_functions.o dynamic_array.o libtest.so vector.o general_functions_par.o prefix_scan.o max_distance.o minmax.o split.o data_types.o data_types_par.o
	$(NVCC) $(CUDAFLAGS) -Xcompiler -fPIC -o prog.out main.o general_functions.o dynamic_array.o test.o vector.o general_functions_par.o prefix_scan.o max_distance.o minmax.o split.o data_types.o data_types_par.o -lm
...
libtest.so: test.o data_types.o general_functions.o dynamic_array.o vector.o data_types_par.o general_functions_par.o prefix_scan.o split.o Sequential/general_functions.h Test/test.h Parallel/general_functions_par.h
	$(NVCC) $(CUDAFLAGS) -Xcompiler -fPIC -shared -o libtest.so test.o general_functions.o dynamic_array.o vector.o general_functions_par.o prefix_scan.o split.o data_types.o data_types_par.o
...
data_types.o: Data_Types/data_types.cu Data_Types/data_types.h
	$(NVCC) $(CUDAFLAGS) -Xcompiler -fPIC -c Data_Types/data_types.cu
...
data_types_par.o: Data_Types/data_types_par.cu Data_Types/data_types_par.h
	$(NVCC) $(CUDAFLAGS) -Xcompiler -fPIC -c Data_Types/data_types_par.cu
